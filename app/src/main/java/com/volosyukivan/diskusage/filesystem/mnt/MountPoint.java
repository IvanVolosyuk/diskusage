...
import com.volosyukivan.diskusage.datasource.fast.PortableFileImpl;
...
public class MountPoint {
  ...
  private static void initMountPoints(Context context) {
    ...
    for (final PortableFile dir : PortableFileImpl.getExternalAppFilesDirs()) {
      String path = dir.getAbsolutePath().replaceFirst("/Android/data/com.volosyukivan.diskusage/files", "");
