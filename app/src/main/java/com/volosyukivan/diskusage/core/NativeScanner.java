...
package com.volosyukivan.diskusage.core;

import android.annotation.SuppressLint;
import android.content.Context;
import androidx.annotation.NonNull;
import com.volosyukivan.diskusage.datasource.DataSource;
import com.volosyukivan.diskusage.datasource.fast.NativeScannerStream;
...
import com.volosyukivan.diskusage.filesystem.entity.FileSystemFile;
import com.volosyukivan.diskusage.filesystem.mnt.MountPoint;
import com.volosyukivan.diskusage.ui.DiskUsage.ProgressGenerator;
...
//    this.blockAllowance = (maxHeap / 2) * sizeThreshold;
  ...
  public FileSystemEntry scan(@NonNull MountPoint mountPoint) throws IOException, InterruptedException {
    ...
    Timber.d("NativeScanner.scan(): Allocated %s B of heap", createdNodeSize);
